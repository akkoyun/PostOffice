...
try:
    ...
    for RAW_Message in Kafka.Payload_Consumer:
        ...
        Handler.Payload_Recorder(RAW_Headers.Stream_ID, RAW_Headers.Device_Time, "AT_FL", Handler.FL_Calculator(Message.AT, Message.AH))
        Handler.Payload_Recorder(RAW_Headers.Stream_ID, RAW_Headers.Device_Time, "AT_Dew", Handler.Dew_Calculator(Message.AT, Message.AH))
        ...
        if Message.R is not None: Handler.Payload_Recorder(RAW_Headers.Stream_ID, RAW_Headers.Device_Time, "R", (Message.R / 200))
