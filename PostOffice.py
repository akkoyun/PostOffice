...
async def Data_POST(request: Request, Data: Schema.Data_Pack, Send_Kafka: BackgroundTasks):
	...
	Log.Terminal_Log("INFO", f"ICCID     : {Data.Info.ICCID}")
	Log.Terminal_Log("INFO", f"IMEI      : {Data.Info.IMEI}")
	...
	Send_Kafka.add_task(Kafka.Send_To_Topic, APP_Settings.KAFKA_KPI_TOPIC, Request_Body, Header, 0)
