...
class Variable(Base):
	...
	# Define Columns
	Variable_ID = Column(Integer, primary_key=True, unique=True, nullable=False)
	Variable_Description = Column(String(), nullable=False)
	Variable_Code = Column(String(), nullable=True)
	Variable_Unit = Column(String(), nullable=True)
...
class Measurement(Base):
	...
	Variable_ID = Column(Integer, ForeignKey("Variable.Variable_ID", ondelete="CASCADE"), nullable=False)
