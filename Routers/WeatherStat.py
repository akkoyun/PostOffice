		...
		async with python_weather.Client(unit=python_weather.METRIC) as client:
			...
			for forecast in weather.forecasts:
				for hourly in forecast.hourly:
					...
					# Set Forecast Model
					Single_Forecast = App_Schema.Forecast(Date=forecast.date, Time=hourly.time, AT=hourly.temperature, CC=hourly.cloud_cover, WS=hourly.wind_speed, WD=str(hourly.wind_direction), CoR=hourly.chances_of_rain, CoS=hourly.chances_of_snow)
