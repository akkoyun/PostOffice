...
# Kafka Discord Consumer
Discord_Consumer = KafkaConsumer(str(APP_Settings.KAFKA_TOPIC_DISCORD), bootstrap_servers=f"{APP_Settings.KAFKA_HOSTNAME}:{APP_Settings.KAFKA_PORT}", group_id=str(APP_Settings.KAFKA_CONSUMER_DISCORD_GROUP), auto_offset_reset='latest', enable_auto_commit=False)
...
# Decode and Parse Discord Message
def Decode_Discord_Message(RAW_Message):
